package space.vakar.weather.persistence.util;
...
import space.vakar.weather.persistence.entities.weather.atmosphere.Atmosphere;
import space.vakar.weather.persistence.entities.weather.atmosphere.Clouds;
import space.vakar.weather.persistence.entities.weather.atmosphere.Humidity;
import space.vakar.weather.persistence.entities.weather.atmosphere.Precipitation;
import space.vakar.weather.persistence.entities.weather.atmosphere.Pressure;
import space.vakar.weather.persistence.entities.weather.atmosphere.Visibility;
import space.vakar.weather.persistence.entities.weather.location.City;
import space.vakar.weather.persistence.entities.weather.location.Coordinates;
import space.vakar.weather.persistence.entities.weather.location.Location;
import space.vakar.weather.persistence.entities.weather.location.Sun;
import space.vakar.weather.persistence.entities.weather.temperature.Temperature;
import space.vakar.weather.persistence.entities.weather.temperature.TemperatureUnit;
import space.vakar.weather.persistence.entities.weather.wind.SpeedUnit;
import space.vakar.weather.persistence.entities.weather.wind.Wind;
import space.vakar.weather.persistence.entities.weather.wind.WindDirection;
import space.vakar.weather.persistence.entities.weather.wind.WindSpeed;
