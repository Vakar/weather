...
import space.vakar.weather.rest.service.CityRestWs;
...
public class CityRestTest extends JerseyTest {
  ...
  private static final String GET_CITIES_BY_NAME_PATH = "/city/";
  ...
  public void returnHttpStatusOk_whenCorrectRequest() {
    Mockito.when(service.findCitiesWithNameLike(CITY_NAME)).thenReturn(cities);
